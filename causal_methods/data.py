...
class SoftPromptDataModule(pl.LightningDataModule):
    ...
    def _get_configs(self, prefixes, phrases):
        ...
        return texts, input_configs, output_configs
    ...
    def train_collate_fn(self, batch):
        ...
        texts, input_configs, output_configs = self._get_configs(prefixes, phrases)
    ...
    def test_collate_fn(self, batch):
        ...
        texts, input_configs, _ = self._get_configs(prefixes, phrases)  
